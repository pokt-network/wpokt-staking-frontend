...
import { useEstimateGas, useUnstakeLPToken } from "@/utils/contract/hooks";
import {
  Center,
  Divider,
  HStack,
...
export default function UnstakeWidget() {
  ...
  const gas = useEstimateGas({ method: "withdraw", address, amount: Number(newWithdrawAmount), isApproval: false });
